...
<head>
    ...
    <title><?php echo $settings['display_name'] ?? 'DOKU'; ?> - <?php echo $setting['response'][0]['site_name']?></title>
...
<body>
    <div class="payment-container">
        <div class="payment-header">
            <div class="payment-logo">
                ...
                <span><?php echo $settings['display_name'] ?? 'DOKU'; ?></span>
            </div>
            <div style="font-size: 0.9rem; color: var(--gray);">Multi-Channel Payment</div>
        </div>

        <div class="payment-body">
            <div class="info-box">
                <i class="fas fa-info-circle"></i> Choose your preferred payment method and complete the transaction securely with DOKU.
            </div>
            ...
            <div style="margin-bottom: 1.5rem;">
                <div style="font-size: 0.9rem; color: var(--gray); margin-bottom: 0.75rem;">Available Payment Methods:</div>
                <div class="payment-methods">
                    <div class="method-badge"><i class="fas fa-university me-1"></i> Bank Transfer</div>
                    <div class="method-badge"><i class="fas fa-mobile me-1"></i> E-Wallet</div>
                    <div class="method-badge"><i class="fas fa-credit-card me-1"></i> Debit Card</div>
                    <div class="method-badge"><i class="fas fa-money-bill me-1"></i> QRIS</div>
                </div>
            </div>

            <button class="btn-pay" id="payButton" onclick="processPayment()">
                <i class="fas fa-credit-card me-2"></i>Proceed to DOKU Checkout
            </button>

            <div class="loading" id="loading">
                <div class="spinner"></div>
                <p>Connecting to DOKU secure gateway...</p>
            </div>
        </div>
    ...
    <script>
        function processPayment() {
            ...
            // This would normally make an API call to DOKU to initiate payment
            console.log('Processing payment with DOKU');
            console.log('Transaction ID:', transactionId);
            console.log('Amount:', amount);

            // Simulate API call
            setTimeout(function() {
                alert('DOKU integration requires server-side API implementation');
