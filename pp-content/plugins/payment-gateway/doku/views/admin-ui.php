...
<form id="dokuSettingsForm" method="post" action="">
    <!-- Page Header -->
        ...
        <div class="d-grid gap-3 gap-lg-5">
            ...
            <div class="card-body">
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" name="display_name" id="display_name" value="<?= htmlspecialchars($settings['display_name'] ?? 'DOKU') ?>">
                    </div>
                ...
                <div class="row mb-4">
                  <div class="col-sm-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="min_amount" id="min_amount" value="<?= htmlspecialchars($settings['min_amount'] ?? '5000') ?>">
                    </div>
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="input-group">
                        <span class="input-group-text">IDR</span>
                        <input type="text" class="form-control" name="max_amount" id="max_amount" value="<?= htmlspecialchars($settings['max_amount'] ?? '2000000000') ?>">
                    </div>
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" name="category" id="category" value="FinTech Payment Gateway" readonly>
                    </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
                <div class="row mb-4">
                  <div class="col-sm-12">
                    <label for="client_id" class="col-sm-12 col-form-label form-label">Client ID</label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="client_id" id="client_id" value="<?= htmlspecialchars($settings['client_id'] ?? '') ?>">
                    </div>
                    <div class="text-secondary mt-2">Your DOKU Client ID</div>
                  </div>

                  <div class="col-sm-12">
                    <label for="secret_key" class="col-sm-12 col-form-label form-label">Secret Key</label>
                    <div class="input-group">
                        <input type="password" class="form-control" name="secret_key" id="secret_key" value="<?= htmlspecialchars($settings['secret_key'] ?? '') ?>">
                    </div>
                    <div class="text-secondary mt-2">Your DOKU Secret Key</div>
                  </div>
                  
                  <div class="col-sm-12">
                    <label for="api_version" class="col-sm-12 col-form-label form-label">API Version</label>
                    <div class="input-group">
                      <select class="form-control" name="api_version" id="api_version">
                        <?php $version = isset($settings['api_version']) ? $settings['api_version'] : 'v1'; ?>
                        <option value="v1" <?php echo ($version === 'v1') ? 'selected' : ''; ?>>v1 (Snap)</option>
                        <option value="v2" <?php echo ($version === 'v2') ? 'selected' : ''; ?>>v2 (API Direct)</option>
                      </select>
                    </div>
                    <div class="text-secondary mt-2">Select API version</div>
                  </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <p>For API keys and configuration, visit: <a href="https://developers.doku.com/" target="_blank">DOKU Developer Dashboard</a></p>
              <p>Documentation: <a href="https://docs.doku.com/" target="_blank">DOKU API Documentation</a></p>
            </div>
          </div>
